...
namespace SG
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        private void HandleRotation(float delta)
        {
            if (inputHandler.lockOnFlag )
            {
                ...
                else
                {
                    ...
                    Quaternion targetrRotation = Quaternion.Slerp(transform.rotation, tr, rotationSpeed * Time.deltaTime);
                    transform.rotation = targetrRotation;
                }
        ...
        public void HandleJumping()
        {
            ...
            //        if (inputHandler.moveAmount > 0)
            //        {
            //            moveDirection = cameraObject.forward * inputHandler.vertical * 50f;

            //            moveDirection += cameraObject.right * inputHandler.horizontal * 50f;
            //            animatorHandler.PlayTargetAnimation("Jump", true);
            //            //moveDirection.y = 0;  
            //            Quaternion jumpRotation = Quaternion.LookRotation(moveDirection);
            //            myTransform.rotation = jumpRotation;
